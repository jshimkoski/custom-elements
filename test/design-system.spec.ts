...
describe('🎨 Design System Components', () => {
  ...
  describe('📝 Component Creation & Attributes', () => {
    it('should create ds-input component with attributes', () => {
      container.innerHTML = '<ds-input model-value="test" placeholder="Enter text"></ds-input>';
    ...
    it('should create ds-textarea component with attributes', () => {
      container.innerHTML = '<ds-textarea rows="5" disabled="true"></ds-textarea>';
    ...
    it('should create ds-checkbox component with attributes', () => {
      container.innerHTML = '<ds-checkbox model-value="true" label="Check me"></ds-checkbox>';
    ...
    it('should create ds-radio-group component', () => {
      container.innerHTML = '<ds-radio-group name="test-group"></ds-radio-group>';
    ...
    it('should create ds-button component with variant', () => {
      container.innerHTML = '<ds-button variant="success" type="submit">Click</ds-button>';
    ...
    it('should create ds-progress component', () => {
      container.innerHTML = '<ds-progress model-value="75" max="100"></ds-progress>';
    ...
    it('should create ds-number component', () => {
      container.innerHTML = '<ds-number model-value="42" min="0" max="100"></ds-number>';
      ...
      if (element.shadowRoot) {
        ...
        if (input) {
          ...
          if (emitSpy.mock.calls.length > 0) {
            expect(emitSpy).toHaveBeenCalledWith('update:model-value', 'test value');
          }
        }
      }
    ...
    it('should handle variant-based styling for buttons', async () => {
      ...
      if (element.shadowRoot) {
        ...
        if (button && button.className) {
          ...
          const hasButtonClasses = button.className.includes('px-4') || 
  ...
  describe('🧪 Error Handling & Edge Cases', () => {
    ...
    it('should handle boolean attributes', () => {
      container.innerHTML = '<ds-checkbox model-value="false" disabled="true"></ds-checkbox>';
      const element = container.querySelector('ds-checkbox') as any;
    ...
    it('should handle numeric attributes', () => {
      container.innerHTML = '<ds-number model-value="123" step="0.1"></ds-number>';
      const element = container.querySelector('ds-number') as any;
