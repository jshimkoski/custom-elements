...
describe('router.browser', () => {
  it('browser mode: push and replace manipulate history and change state', async () => {
    const history: any = { pushState: () => {}, replaceState: () => {}, back: () => {} };
    (global as any).window = { location: { href: 'http://localhost/', pathname: '/', search: '' }, history, addEventListener: (name: string, cb: any) => {} };
    (global as any).document = {};

    const routes = [ { path: '/', component: 'root' }, { path: '/b', component: 'b' } ];
  ...
  it('base path is stripped from incoming URLs', () => {
    const history: any = { pushState: () => {}, replaceState: () => {}, back: () => {} };
    (global as any).window = { location: { href: 'http://localhost/base/x', pathname: '/base/x', search: '' }, history, addEventListener: () => {} };
    (global as any).document = {};
