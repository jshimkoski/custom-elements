...
if (typeof (window as any).CSSStyleSheet === 'function' && typeof (window as any).CSSStyleSheet.prototype.replaceSync !== 'function') {
  (window as any).CSSStyleSheet.prototype.replaceSync = function (_source: string) {
