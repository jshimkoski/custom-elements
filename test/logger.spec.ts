...
describe('🔧 Logger Utilities', () => {
  ...
  describe('Development Mode Logging (Test Environment)', () => {
    ...
    describe('devError', () => {
      ...
      it('should log error with message and arguments', () => {
        ...
        expect(mockConsole.error).toHaveBeenCalledTimes(1);
        expect(mockConsole.error).toHaveBeenCalledWith(message, arg1, arg2, arg3);
      });
      ...
      it('should handle multiple consecutive error calls', () => {
        ...
        expect(mockConsole.error).toHaveBeenNthCalledWith(2, 'Second error', { data: 'test' });
      ...
      it('should handle complex objects as arguments', () => {
        ...
        expect(mockConsole.error).toHaveBeenCalledTimes(1);
        expect(mockConsole.error).toHaveBeenCalledWith('Complex object error', complexObj);
      });
    });
    ...
    describe('Mixed Logging', () => {
      it('should handle mixed logging calls', () => {
        ...
        expect(mockConsole.warn).toHaveBeenCalledWith('Warning message', { data: 'test' });
  ...
  describe('Edge Cases and Error Handling', () => {
    it('should handle null and undefined arguments', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith('Error with nulls', null, undefined);
      expect(mockConsole.warn).toHaveBeenCalledWith('Warning with nulls', null, undefined);
      expect(mockConsole.log).toHaveBeenCalledWith('Log with nulls', null, undefined);
    });
    ...
    it('should handle circular references', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith('Circular reference', circular);
      expect(mockConsole.warn).toHaveBeenCalledWith('Circular reference', circular);
      expect(mockConsole.log).toHaveBeenCalledWith('Circular reference', circular);
    });
  ...
  describe('Production Behavior Documentation', () => {
    it('should document production behavior expectations', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith('Test production behavior');
