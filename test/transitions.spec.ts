...
import { component, html, ref, Transition, TransitionGroup, transitionPresets, each } from '../src/lib/index';
...
describe('Transitions', () => {
  ...
  describe('Transition Presets', () => {
    ...
    it('should have slide-right preset', () => {
      ...
      expect(transitionPresets['slide-right'].enterFrom).toContain('translate-x-[100%]');
    });

    it('should have slide-left preset', () => {
      expect(transitionPresets['slide-left']).toBeDefined();
      expect(transitionPresets['slide-left'].enterFrom).toContain('translate-x-[-100%]');
    });

    it('should have slide-up preset', () => {
      expect(transitionPresets['slide-up']).toBeDefined();
      expect(transitionPresets['slide-up'].enterFrom).toContain('translate-y-[100%]');
    });

    it('should have slide-down preset', () => {
      expect(transitionPresets['slide-down']).toBeDefined();
      expect(transitionPresets['slide-down'].enterFrom).toContain('translate-y-[-100%]');
    });
